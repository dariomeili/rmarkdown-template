...
author: 
  - First Author^[Institution, University, <email@address.com>]
  - Second Author^[Other Institution, Other University, <email@address.com>]
date: \today
abstract: |
...
output: 
  bookdown::pdf_document2:
    ...
    number_sections: yes
    toc: false
    extra_dependencies: ["placeins", "flafter", "subfig"]
---
...
# load data or run cleainingfile in case file does not exist
